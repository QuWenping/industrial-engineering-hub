...
- [Reynolds Number Calculator](/tools/reynolds-number-calculator) — compute Re for any fluid and pipe
- [Pipe Flow Calculator](/tools/pipe-flow-calculator) — flow regime and capacity analysis
- [Pipe Velocity Calculator](/tools/pipe-velocity-calculator) — velocity from flow and diameter
- [Flow Rate Calculator](/tools/flow-rate-calculator) — volumetric and mass flow conversion
- [Pipe Diameter Calculator](/tools/pipe-diameter-calculator) — sizing for target velocity
- [Pressure Drop Calculator](/tools/pressure-drop-calculator) — friction loss in pipes
- [Friction Loss Calculator](/tools/friction-loss-calculator) — Darcy-Weisbach friction factor
- [Darcy-Weisbach Calculator](/tools/darcy-weisbach-calculator) — head loss from friction
- [Hydraulic Diameter Calculator](/tools/hydraulic-diameter-calculator) — non-circular ducts
- [Orifice Flow Calculator](/tools/orifice-flow-calculator) — flow through restrictions
