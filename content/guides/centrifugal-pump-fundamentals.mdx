...
Centrifugal pumps suit low-viscosity, high-flow duties; when the service is high-viscosity, metering or very high pressure, see the [Positive Displacement Pumps](/guides/positive-displacement-pumps) guide. Match either family to the system with the [Pump Selection Guide](/guides/pump-selection-guide) and size the driver with the [Pump Power Calculator](/tools/pump-power-calculator). Track operating energy with the [Pump Energy Calculator](/tools/pump-energy-calculator), verify suction conditions with the [NPSH Calculator](/tools/npsh-calculator), and estimate delivered flow with the [Pump Flow Calculator](/tools/pump-flow-calculator).
