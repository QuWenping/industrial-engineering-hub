...
**What is the most common type of corrosion in industrial plants?**
Uniform (general) corrosion is the most common and predictable — even metal loss across a surface, managed with corrosion allowance. However, localized forms (pitting, crevice corrosion, SCC, and CUI) cause the most unexpected failures and are more dangerous because they perforate with minimal metal loss.

**How much corrosion allowance should I add?**
Typical allowances: 1.0-1.5mm for clean process service (steam, air, oil), 1.5-2.0mm for treated cooling water, 2.0-3.0mm for raw water, 3.0mm+ for seawater, and 3.0-6.0mm for aggressive chemicals.

**What is corrosion under insulation (CUI)?**
CUI is hidden corrosion caused by water trapped between insulation and pipe, most severe in the 50-150°C range. It is the #1 maintenance issue in refineries. Prevention: non-absorptive insulation (cellular glass), sealed jacket seams, protective coating before insulating, and RBI inspection every 5-10 years.

**How does cathodic protection work?**
Cathodic protection makes the structure the cathode of an electrochemical cell. Sacrificial anodes (zinc, magnesium, aluminum) corrode instead of the steel; impressed current CP uses an external DC supply with inert anodes for large pipelines and tank bottoms.

**When should I upgrade from 304 to 316 stainless steel?**
Upgrade to 316/316L for marine/coastal installations, process fluids containing chlorides, reducing acids, or when chloride SCC above 60°C is a risk. 316's 2-3% molybdenum provides superior pitting and crevice corrosion resistance.

## Related Engineering Tools

- [Pipe Material Selection](/guides/pipe-material-selection) — Choose corrosion-resistant materials
- [Steel Material Properties](/guides/steel-material-properties) — Carbon steel data
- [Stainless Steel 304](/materials/stainless-steel-304) — General-purpose stainless grade
- [Stainless Steel 316](/materials/stainless-steel-316) — Chloride-resistant upgrade
- [Insulation Selection Guide](/guides/insulation-selection-guide) — Prevent CUI
- [Pipe Stress Analysis Basics](/guides/pipe-stress-analysis-basics) — Design for thermal stress
- [Material Strength Basics](/guides/material-strength-basics) — Material selection fundamentals
- [Steam System Fundamentals](/guides/steam-system-fundamentals) — Corrosion in steam/condensate systems
