---
title: "Positive Displacement Pumps: Types, Working Principle & Applications"
description: "Positive displacement pump types (gear, screw, lobe, piston, plunger, diaphragm), working principle, PD vs centrifugal comparison, and troubleshooting."
...
For total driver operating cost, combine the shaft power with the [Pump Energy Calculator](/tools/pump-energy-calculator). The comparison table below explains when a PD pump is the right family versus a centrifugal machine.
...
Use this with the selection table above to shortlist a pump family, then confirm with the [Pump Selection Calculator](/tools/pump-selection-calculator).
...
Use this comparison to shortlist a pump family from your duty, then refine with the [Pump Selection Calculator](/tools/pump-selection-calculator) and the [Pump Sizing Calculator](/tools/pump-sizing-calculator). Flow figures are typical operating ranges for standard commercial machines, not absolute limits.
