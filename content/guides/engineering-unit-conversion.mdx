...
**How do I convert dynamic viscosity from centipoise to Pa·s?**
1 cP = 0.001 Pa·s (1 mPa·s). Water at 20°C is 1.002 cP ≈ 0.001 Pa·s. To convert cP to Pa·s, divide by 1000; to convert Pa·s to cP, multiply by 1000. Kinematic viscosity in cSt converts to m²/s by dividing by 1,000,000 (1 cSt = 1×10⁻⁶ m²/s).
## Summary
