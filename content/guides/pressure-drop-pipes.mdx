---
title: "Pipe Pressure Drop Calculation Guide — Darcy-Weisbach & Hazen-Williams"
...
The Darcy-Weisbach equation is the most universally accurate method and works for all Newtonian fluids. The Hazen-Williams formula is restricted to water at typical ambient temperatures (40-75°F / 5-25°C) but is simpler for water distribution and fire protection design. Apply the equations with the [Pressure Drop Calculator](/tools/pressure-loss-calculator) and [Pressure Loss Calculator](/tools/pressure-loss-calculator); sizing inputs come from the [Pipe Velocity Calculator](/tools/pipe-velocity-calculator), [Pipe Flow Calculator](/tools/pipe-flow-calculator), [Pipe Diameter Calculator](/tools/pipe-diameter-calculator) and [Flow Rate Calculator](/tools/flow-rate-calculator).
</Callout>
...
Where:
- **ΔP** = pressure drop (Pa)
- **f** = Darcy friction factor (dimensionless) (depends on the flow regime — see the [Reynolds Number Guide](/guides/reynolds-number-guide))
- **L** = pipe length (m)
