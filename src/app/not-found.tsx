...
// Flag to prevent AdSense from loading on 404/error pages (AdSense policy:
// no ad code on error pages). This inline script runs during HTML parsing,
// before any afterInteractive scripts can load.
export default function NotFound() {
  return (
    <div>
      <script dangerouslySetInnerHTML={{ __html: "window.__noAds=true" }} />
